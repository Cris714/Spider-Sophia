...
//             points.add(t_point3(
//                 t_point(l0t[i][0] + j*gamma*dx0, l0t[i][1] + j*gamma*dy0, l0t[i][2] + j*gamma*dz0),
//                 t_point(l1t[2][0] + (i+j*gamma)*dx1, l1t[0][1], l1t[2][2] + (i+j*gamma)*dz1),
//                 t_point((l2t[0][0] + l2t[2][0])/2 + (i+j*gamma)*dx2, l2t[0][1], (l2t[0][2] + l2t[2][2])/2 + (i+j*gamma)*dz2)
//                 ));
//         }
//     }
...
//             points.add(t_point3(
//                 t_point(l2t[i][0] + j*gamma*dx2, l2t[i][1] + j*gamma*dy2, l2t[i][2] + j*gamma*dz2),
//                 t_point(l0t[2][0] + (i+j*gamma)*dx0, l0t[0][1], l0t[2][2] + (i+j*gamma)*dz0),
//                 t_point((l1t[0][0] + l1t[2][0])/2 + (i+j*gamma)*dx1, l1t[0][1], (l1t[0][2] + l1t[2][2])/2 + (i+j*gamma)*dz1)
//             ));
//         }
//     }
...
//             List<t_point> sequence;
//             points.add(t_point3(
//                 t_point(l1t[i][0] + j*gamma*dx1, l1t[i][1] + j*gamma*dy1, l1t[i][2] + j*gamma*dz1),
//                 t_point(l2t[2][0] + (i+j*gamma)*dx2, l2t[0][1], l2t[2][2] + (i+j*gamma)*dz2),
//                 t_point((l0t[0][0] + l0t[2][0])/2 + (i+j*gamma)*dx0, l0t[0][1], (l0t[0][2] + l0t[2][2])/2 + (i+j*gamma)*dz0)
//             ));
//         }
//     }
