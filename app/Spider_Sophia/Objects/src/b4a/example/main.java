...
mostCurrent._tabhost1.AddTab(mostCurrent.activityBA,"Conn","Connect");
 //BA.debugLineNum = 51;BA.debugLine="TabHost1.AddTab(\"Tasks\", \"Tasks\")";
mostCurrent._tabhost1.AddTab(mostCurrent.activityBA,"Tasks","Tasks");
 //BA.debugLineNum = 52;BA.debugLine="TabHost1.AddTab(\"Cam\", \"Cam\")";
mostCurrent._tabhost1.AddTab(mostCurrent.activityBA,"Cam","Cam");
 //BA.debugLineNum = 55;BA.debugLine="ip.Text=\"192.168.4.1\"";
mostCurrent._ip.setText(BA.ObjectToCharSequence("192.168.4.1"));
 //BA.debugLineNum = 56;BA.debugLine="port.Text=\"3000\"";
mostCurrent._port.setText(BA.ObjectToCharSequence("3000"));
 //BA.debugLineNum = 59;BA.debugLine="js1.ButtonDrawable = \"button\"";
mostCurrent._js1.setButtonDrawable("button");
 //BA.debugLineNum = 60;BA.debugLine="js1.PadBackground = \"pad\"";
mostCurrent._js1.setPadBackground("pad");
 //BA.debugLineNum = 63;BA.debugLine="cd1.Initialize(Colors.RGB(231, 102, 136), 10dip)";
mostCurrent._cd1.Initialize(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (231),(int) (102),(int) (136)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)));
 //BA.debugLineNum = 64;BA.debugLine="cd2.Initialize(Colors.RGB(120, 184, 169), 10dip)";
mostCurrent._cd2.Initialize(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (120),(int) (184),(int) (169)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)));
 //BA.debugLineNum = 65;BA.debugLine="Mov_xz.Background = cd1";
mostCurrent._mov_xz.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cd1.getObject()));
 //BA.debugLineNum = 66;BA.debugLine="click_enabled = True";
_click_enabled = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 67;BA.debugLine="task_state = 0 ' [0]: Mov(x/z), [1]: Turn(phi), [";
_task_state = (int) (0);
 //BA.debugLineNum = 68;BA.debugLine="Active_Button = Mov_xz";
mostCurrent._active_button = mostCurrent._mov_xz;
 //BA.debugLineNum = 70;BA.debugLine="Coords_info.Text = \"Ang = 0\" & CRLF & _ 					   \"";
...
if (_firsttime) { 
 //BA.debugLineNum = 80;BA.debugLine="udps.Initialize(\"UdpSEvent\", 0, 5000)";
_udps.Initialize(processBA,"UdpSEvent",(int) (0),(int) (5000));
 //BA.debugLineNum = 81;BA.debugLine="delayTimer.Initialize(\"delayTimer\", 12)";
_delaytimer.Initialize(processBA,"delayTimer",(long) (12));
 //BA.debugLineNum = 82;BA.debugLine="walkTimer.Initialize(\"walkTimer\", 100)";
_walktimer.Initialize(processBA,"walkTimer",(long) (100));
 //BA.debugLineNum = 83;BA.debugLine="walkTimer.Enabled = True";
...
public static String  _connect_click() throws Exception{
 //BA.debugLineNum = 96;BA.debugLine="Private Sub Connect_Click";
 //BA.debugLineNum = 97;BA.debugLine="serverIp = ip.Text";
mostCurrent._serverip = mostCurrent._ip.getText();
 //BA.debugLineNum = 98;BA.debugLine="serverPort = port.Text";
mostCurrent._serverport = mostCurrent._port.getText();
 //BA.debugLineNum = 100;BA.debugLine="ToastMessageShow(\"Connected to IP = \" & serverIp";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Connected to IP = "+mostCurrent._serverip+", Port = "+mostCurrent._serverport),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 101;BA.debugLine="TabHost1.CurrentTab = 1";
mostCurrent._tabhost1.setCurrentTab((int) (1));
 //BA.debugLineNum = 102;BA.debugLine="End Sub";
return "";
}
public static String  _delaytimer_tick() throws Exception{
 //BA.debugLineNum = 178;BA.debugLine="Sub delayTimer_Tick";
 //BA.debugLineNum = 179;BA.debugLine="delayTimer.Enabled = False";
_delaytimer.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 180;BA.debugLine="click_enabled = True";
_click_enabled = anywheresoftware.b4a.keywords.Common.True;
...
mostCurrent._serverport = "";
 //BA.debugLineNum = 30;BA.debugLine="Dim click_enabled As Boolean";
...
mostCurrent._pckt = "";
 //BA.debugLineNum = 38;BA.debugLine="Dim Active_Button, Mov_xz, Turn_phi, Mov_y, Turn_";
...
mostCurrent._walk = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 39;BA.debugLine="Dim Coords_info As Label";
...
mostCurrent._cd2 = new anywheresoftware.b4a.objects.drawable.ColorDrawable();
 //BA.debugLineNum = 44;BA.debugLine="Dim WebView1 As WebView";
...
float _radlmt = 0f;
 //BA.debugLineNum = 140;BA.debugLine="Sub joystick_action(deg As Double, powr As Double)";
 //BA.debugLineNum = 141;BA.debugLine="If task_state = 0 Then 'Mov(x/z)";
if (_task_state==0) { 
 //BA.debugLineNum = 142;BA.debugLine="radio = powr / 100 * 4";
_radio = (float) (_powr/(double)100*4);
 //BA.debugLineNum = 144;BA.debugLine="x = Min( Max(radio * Sin(deg), -4), 4 )";
_x = (float) (anywheresoftware.b4a.keywords.Common.Min(anywheresoftware.b4a.keywords.Common.Max(_radio*anywheresoftware.b4a.keywords.Common.Sin(_deg),-4),4));
 //BA.debugLineNum = 145;BA.debugLine="z = Min( Max(radio * Cos(deg), -4), 4 )";
_z = (float) (anywheresoftware.b4a.keywords.Common.Min(anywheresoftware.b4a.keywords.Common.Max(_radio*anywheresoftware.b4a.keywords.Common.Cos(_deg),-4),4));
 ...
 //BA.debugLineNum = 148;BA.debugLine="Dim radlmt As Float= 20 * (cPI / 180)";
_radlmt = (float) (20*(anywheresoftware.b4a.keywords.Common.cPI/(double)180));
 //BA.debugLineNum = 149;BA.debugLine="radio = powr / 100 * radlmt";
_radio = (float) (_powr/(double)100*_radlmt);
 //BA.debugLineNum = 151;BA.debugLine="thy = Min( Max(radio * Sin (deg), -radlmt), radl";
_thy = (float) (anywheresoftware.b4a.keywords.Common.Min(anywheresoftware.b4a.keywords.Common.Max(_radio*anywheresoftware.b4a.keywords.Common.Sin(_deg),-_radlmt),_radlmt));
 ...
 //BA.debugLineNum = 154;BA.debugLine="radio = powr / 100 * 4 '( 5 - (-3) ) / 2";
_radio = (float) (_powr/(double)100*4);
 //BA.debugLineNum = 155;BA.debugLine="y = Min( Max(radio * Cos (deg), -4), 4 )";
_y = (float) (anywheresoftware.b4a.keywords.Common.Min(anywheresoftware.b4a.keywords.Common.Max(_radio*anywheresoftware.b4a.keywords.Common.Cos(_deg),-4),4));
 ...
 //BA.debugLineNum = 158;BA.debugLine="Dim radlmt As Float= 20 * (cPI / 180)";
_radlmt = (float) (20*(anywheresoftware.b4a.keywords.Common.cPI/(double)180));
 //BA.debugLineNum = 159;BA.debugLine="radio = powr / 100 * radlmt";
_radio = (float) (_powr/(double)100*_radlmt);
 //BA.debugLineNum = 161;BA.debugLine="thx = Min( Max(radio * Sin (deg), -radlmt), radl";
_thx = (float) (anywheresoftware.b4a.keywords.Common.Min(anywheresoftware.b4a.keywords.Common.Max(_radio*anywheresoftware.b4a.keywords.Common.Sin(_deg),-_radlmt),_radlmt));
 //BA.debugLineNum = 162;BA.debugLine="thz = Min( Max(radio * Cos (deg), -radlmt), radl";
...
public static String  _js1_value_changed(double _angle,double _angledegrees,double _powr) throws Exception{
 //BA.debugLineNum = 104;BA.debugLine="Sub js1_value_changed(Angle As Double, angleDegree";
 //BA.debugLineNum = 105;BA.debugLine="ang = Angle - cPI / 2";
_ang = (float) (_angle-anywheresoftware.b4a.keywords.Common.cPI/(double)2);
 //BA.debugLineNum = 106;BA.debugLine="If ang < (-cPI) Then ang = ang + 2*cPI";
if (_ang<(-anywheresoftware.b4a.keywords.Common.cPI)) { 
_ang = (float) (_ang+2*anywheresoftware.b4a.keywords.Common.cPI);};
 //BA.debugLineNum = 107;BA.debugLine="pwr = powr";
_pwr = (float) (_powr);
 //BA.debugLineNum = 108;BA.debugLine="joystick_action(ang, pwr)";
_joystick_action(_ang,_pwr);
 //BA.debugLineNum = 110;BA.debugLine="Coords_info.Text = \"Ang = \" & Round2(ang, 2) & CR";
mostCurrent._coords_info.setText(BA.ObjectToCharSequence("Ang = "+BA.NumberToString(anywheresoftware.b4a.keywords.Common.Round2(_ang,(int) (2)))+anywheresoftware.b4a.keywords.Common.CRLF+"Pwr = "+BA.NumberToString(anywheresoftware.b4a.keywords.Common.Round2(_pwr,(int) (2)))+anywheresoftware.b4a.keywords.Common.CRLF+"x   = "+BA.NumberToString(anywheresoftware.b4a.keywords.Common.Round2(_x,(int) (2)))+anywheresoftware.b4a.keywords.Common.CRLF+"y   = "+BA.NumberToString(anywheresoftware.b4a.keywords.Common.Round2(_y,(int) (2)))+anywheresoftware.b4a.keywords.Common.CRLF+"z   = "+BA.NumberToString(anywheresoftware.b4a.keywords.Common.Round2(_z,(int) (2)))+anywheresoftware.b4a.keywords.Common.CRLF+"th  = "+BA.NumberToString(anywheresoftware.b4a.keywords.Common.Round2(_thx,(int) (2)))+anywheresoftware.b4a.keywords.Common.CRLF+"phi = "+BA.NumberToString(anywheresoftware.b4a.keywords.Common.Round2(_thy,(int) (2)))+anywheresoftware.b4a.keywords.Common.CRLF+"psi = "+BA.NumberToString(anywheresoftware.b4a.keywords.Common.Round2(_thz,(int) (2)))));
 //BA.debugLineNum = 119;BA.debugLine="If click_enabled And task_state <> 4 Then";
if (_click_enabled && _task_state!=4) { 
 //BA.debugLineNum = 120;BA.debugLine="delayTimer.Enabled = True";
_delaytimer.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 121;BA.debugLine="click_enabled = False";
_click_enabled = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 123;BA.debugLine="If task_state = 0 And (x <> 0 Or z <> 0) Then";
if (_task_state==0 && (_x!=0 || _z!=0)) { 
 //BA.debugLineNum = 124;BA.debugLine="pckt = transfCoords(x, 0, z, 0, 0, 0)";
mostCurrent._pckt = _transfcoords(_x,0,_z,0,0,0);
 }else if(_task_state==1 && _thy!=0) { 
 //BA.debugLineNum = 126;BA.debugLine="pckt = transfCoords(0, 0, 0, 0, thy, 0)";
mostCurrent._pckt = _transfcoords(0,0,0,0,_thy,0);
 }else if(_task_state==2 && _y!=0) { 
 //BA.debugLineNum = 128;BA.debugLine="pckt = transfCoords(0, y+1, 0, 0, 0, 0)";
mostCurrent._pckt = _transfcoords(0,_y+1,0,0,0,0);
 }else if(_task_state==3 && (_thx!=0 || _thz!=0)) { 
 //BA.debugLineNum = 130;BA.debugLine="pckt = transfCoords(0, 0, 0, thx, 0, thz)";
mostCurrent._pckt = _transfcoords(0,0,0,_thx,0,_thz);
 };
 //BA.debugLineNum = 133;BA.debugLine="Log(pckt)";
anywheresoftware.b4a.keywords.Common.LogImpl("3393245",mostCurrent._pckt,0);
 //BA.debugLineNum = 134;BA.debugLine="Send_Packet(pckt)";
...
public static String  _mov_xz_click() throws Exception{
 //BA.debugLineNum = 193;BA.debugLine="Private Sub Mov_xz_Click";
 //BA.debugLineNum = 194;BA.debugLine="Active_Button.Background = cd2";
mostCurrent._active_button.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cd2.getObject()));
 //BA.debugLineNum = 196;BA.debugLine="task_state = 0";
_task_state = (int) (0);
 //BA.debugLineNum = 197;BA.debugLine="Log(\"Mov(x/z)\")";
anywheresoftware.b4a.keywords.Common.LogImpl("3786436","Mov(x/z)",0);
 //BA.debugLineNum = 199;BA.debugLine="Mov_xz.Background = cd1";
mostCurrent._mov_xz.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cd1.getObject()));
 //BA.debugLineNum = 200;BA.debugLine="Active_Button = Mov_xz";
mostCurrent._active_button = mostCurrent._mov_xz;
 //BA.debugLineNum = 201;BA.debugLine="End Sub";
return "";
}
public static String  _mov_y_click() throws Exception{
 //BA.debugLineNum = 213;BA.debugLine="Private Sub Mov_y_Click";
 //BA.debugLineNum = 214;BA.debugLine="Active_Button.Background = cd2";
mostCurrent._active_button.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cd2.getObject()));
 //BA.debugLineNum = 216;BA.debugLine="task_state = 2";
_task_state = (int) (2);
 //BA.debugLineNum = 217;BA.debugLine="Log(\"Mov(y)\")";
anywheresoftware.b4a.keywords.Common.LogImpl("3917508","Mov(y)",0);
 //BA.debugLineNum = 219;BA.debugLine="Mov_y.Background = cd1";
mostCurrent._mov_y.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cd1.getObject()));
 //BA.debugLineNum = 220;BA.debugLine="Active_Button = Mov_y";
...
_udpp = new anywheresoftware.b4a.objects.SocketWrapper.UDPSocket.UDPPacket();
 //BA.debugLineNum = 22;BA.debugLine="Dim delayTimer, walkTimer As Timer";
...
public static String  _send_packet(String _msg) throws Exception{
 //BA.debugLineNum = 171;BA.debugLine="Sub Send_Packet(msg As String)";
 //BA.debugLineNum = 172;BA.debugLine="serverIp = ip.Text";
mostCurrent._serverip = mostCurrent._ip.getText();
 //BA.debugLineNum = 173;BA.debugLine="serverPort = port.Text";
mostCurrent._serverport = mostCurrent._port.getText();
...
public static String  _tabhost1_tabchanged() throws Exception{
 //BA.debugLineNum = 243;BA.debugLine="Private Sub TabHost1_TabChanged";
 //BA.debugLineNum = 244;BA.debugLine="If TabHost1.CurrentTab = 2 Then";
if (mostCurrent._tabhost1.getCurrentTab()==2) { 
 //BA.debugLineNum = 245;BA.debugLine="WebView1.LoadUrl(\"http://192.168.3.107\")";
...
public static String  _transfcoords(double _xi,double _yi,double _zi,double _th,double _phi,double _psi) throws Exception{
 //BA.debugLineNum = 167;BA.debugLine="Sub transfCoords(xi As Double, yi As Double, zi As";
 //BA.debugLineNum = 168;BA.debugLine="Return \"C\" & Round2(xi, 2) & \",\" & Round2(yi, 2)";
...
public static String  _turn_phi_click() throws Exception{
 //BA.debugLineNum = 203;BA.debugLine="Private Sub Turn_phi_Click";
 //BA.debugLineNum = 204;BA.debugLine="Active_Button.Background = cd2";
mostCurrent._active_button.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cd2.getObject()));
 //BA.debugLineNum = 206;BA.debugLine="task_state = 1";
_task_state = (int) (1);
 //BA.debugLineNum = 207;BA.debugLine="Log(\"Turn(phi)\")";
anywheresoftware.b4a.keywords.Common.LogImpl("3851972","Turn(phi)",0);
 //BA.debugLineNum = 209;BA.debugLine="Turn_phi.Background = cd1";
mostCurrent._turn_phi.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cd1.getObject()));
 //BA.debugLineNum = 210;BA.debugLine="Active_Button = Turn_phi";
mostCurrent._active_button = mostCurrent._turn_phi;
 //BA.debugLineNum = 211;BA.debugLine="End Sub";
return "";
}
public static String  _turn_thpsi_click() throws Exception{
 //BA.debugLineNum = 223;BA.debugLine="Private Sub Turn_thpsi_Click";
 //BA.debugLineNum = 224;BA.debugLine="Active_Button.Background = cd2";
mostCurrent._active_button.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cd2.getObject()));
 //BA.debugLineNum = 226;BA.debugLine="task_state = 3";
_task_state = (int) (3);
 //BA.debugLineNum = 227;BA.debugLine="Log(\"Turn(th/psi)\")";
anywheresoftware.b4a.keywords.Common.LogImpl("3983044","Turn(th/psi)",0);
 //BA.debugLineNum = 229;BA.debugLine="Turn_thpsi.Background = cd1";
mostCurrent._turn_thpsi.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cd1.getObject()));
 //BA.debugLineNum = 230;BA.debugLine="Active_Button = Turn_thpsi";
mostCurrent._active_button = mostCurrent._turn_thpsi;
 //BA.debugLineNum = 231;BA.debugLine="End Sub";
return "";
}
public static String  _walk_click() throws Exception{
 //BA.debugLineNum = 233;BA.debugLine="Private Sub Walk_Click";
 //BA.debugLineNum = 234;BA.debugLine="Active_Button.Background = cd2";
mostCurrent._active_button.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cd2.getObject()));
 //BA.debugLineNum = 236;BA.debugLine="task_state = 4";
_task_state = (int) (4);
 //BA.debugLineNum = 237;BA.debugLine="Log(\"Walk\")";
anywheresoftware.b4a.keywords.Common.LogImpl("31048580","Walk",0);
 //BA.debugLineNum = 239;BA.debugLine="walk.Background = cd1";
mostCurrent._walk.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cd1.getObject()));
 //BA.debugLineNum = 240;BA.debugLine="Active_Button = walk";
mostCurrent._active_button = mostCurrent._walk;
 //BA.debugLineNum = 241;BA.debugLine="End Sub";
return "";
}
public static String  _walktimer_tick() throws Exception{
 //BA.debugLineNum = 183;BA.debugLine="Sub walkTimer_Tick";
 //BA.debugLineNum = 184;BA.debugLine="If task_state = 4 And pwr <> 0 Then";
if (_task_state==4 && _pwr!=0) { 
 //BA.debugLineNum = 185;BA.debugLine="radio = Max( pwr / 100 * 1.2, 0.2)";
_radio = (float) (anywheresoftware.b4a.keywords.Common.Max(_pwr/(double)100*1.2,0.2));
 //BA.debugLineNum = 186;BA.debugLine="pckt = \"W\" & Round2(ang, 2) & \",\" & Round2(radio";
mostCurrent._pckt = "W"+BA.NumberToString(anywheresoftware.b4a.keywords.Common.Round2(_ang,(int) (2)))+","+BA.NumberToString(anywheresoftware.b4a.keywords.Common.Round2(_radio,(int) (2)));
 //BA.debugLineNum = 188;BA.debugLine="Log(pckt)";
anywheresoftware.b4a.keywords.Common.LogImpl("3720901",mostCurrent._pckt,0);
 //BA.debugLineNum = 189;BA.debugLine="Send_Packet(pckt)";
_send_packet(mostCurrent._pckt);
 };
